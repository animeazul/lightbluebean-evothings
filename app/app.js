    ...
    function onScanSuccess(device)
    {
        function onConnectSuccess(device)
        {
            function onServiceSuccess(device)
            {
                ...
                app.interval = setInterval(function() { app.readBattery(); }, 1000);
            }
...
app.readBattery = function()
{
    function onDataReadSuccess(data)
    {
        var BatteryData = new Uint8Array(data);
        var Battery = BatteryData[0];
    ...
    app.readDataFromScratch(3, onDataReadSuccess, onDataReadFailure);
};
